...
//人脸融合
public static  function mergeface($image_path,$template,$isbigface)
{
    // $real_image_path = realpath($image_path);//搜索TP根目录下
    //     // dump($real_image_path);
    //     // exit();
    ...
    //     }
        ...
        $post_data = array(
            ...
            'opdata'=>array(
              ...
              // "{'cmd':'doFaceMerge',
              // 'params':{'model_id':'cf_lover_fanli'}")  
            )
        );
